package org.firstinspires.ftc.teamcode.ultimategoal.flyweelPIDtuning;
...
public class VeloPIDTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        // Change my id
        DcMotorEx myMotor = hardwareMap.get(DcMotorEx.class, "shooterFront");
        ...
        myMotor.setMode(DcMotorEx.RunMode.RUN_USING_ENCODER);
