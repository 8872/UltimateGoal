...
public class TestChassisDriveConstants extends DriveConstants {
    ...
    private static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0, getMotorVelocityFImpl(MAX_RPM / 60 * TICKS_PER_REV));
    ...
    public static double getMotorVelocityFImpl(double ticksPerSecond) {
