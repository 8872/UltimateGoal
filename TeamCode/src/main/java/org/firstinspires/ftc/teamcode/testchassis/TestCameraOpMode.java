...
public class TestCameraOpMode extends OpMode
{
    ...
    public void loop() {
        ...
        telemetry.addData("X Pose: ", up.pose.getTranslation().getX() / 0.0254);
        telemetry.addData("Y Pose: ", up.pose.getTranslation().getY() / 0.0254);
        telemetry.addData("Rotation(Degrees) ", up.pose.getRotation().getDegrees());
        telemetry.update();
    }
