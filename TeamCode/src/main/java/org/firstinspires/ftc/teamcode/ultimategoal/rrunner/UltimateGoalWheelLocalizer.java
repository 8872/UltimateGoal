 ...
 */
@Config
class UltimateGoalWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 14.82; // in; distance between the left and right wheels
