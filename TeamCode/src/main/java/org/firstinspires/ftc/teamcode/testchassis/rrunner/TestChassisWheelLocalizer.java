 ...
 */
//@Config
public class TestChassisWheelLocalizer extends ThreeTrackingWheelLocalizer {
    public static double TICKS_PER_REV = 8192;
    public static double WHEEL_RADIUS = 0.748031; // in - 19mm, 38 millimeter odometry wheels
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    // Need to be changed for test chassis
    ...
    public TestChassisWheelLocalizer(HardwareMap hardwareMap) {
        super(Arrays.asList(
